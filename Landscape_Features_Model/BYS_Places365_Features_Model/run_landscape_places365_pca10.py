...
def process_landscape_places365_pca_10() -> None:
    print("================ 1. Load 512D landscape Places365 features ================")
    base_dir = Path(__file__).resolve().parent
    input_csv = base_dir / "landscape_places365_features.csv"
    output_csv = base_dir / "PCA_10_places365.csv"
    output_plot = base_dir / "Places365_PCA_10_Variance.png"
    output_pkl = base_dir / "landscape_places365_pca_10d.pkl"
    ...
    plt.title("Landscape Places365 Explained Variance: 512D to 10D", fontsize=16, weight="bold")
...
if __name__ == "__main__":
    process_landscape_places365_pca_10()
