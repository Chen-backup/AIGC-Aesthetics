...
def process_landscape_stylegan_pca_10() -> None:
    print("================ 1. Load 9216D landscape StyleGAN W+ features ================")
    base_dir = Path(__file__).resolve().parent
    input_csv = base_dir / "landscape_stylegan_w_features.csv"
    output_csv = base_dir / "PCA_10_stylegan_w.csv"
    output_plot = base_dir / "StyleGAN_PCA_10_Variance.png"
    output_pkl = base_dir / "landscape_stylegan_pca_10d.pkl"
    ...
    plt.title("Landscape StyleGAN-W+ Explained Variance: 9216D to 10D", fontsize=16, weight="bold")
...
if __name__ == "__main__":
    process_landscape_stylegan_pca_10()
