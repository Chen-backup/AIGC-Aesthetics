...
def analyze_excluded_files():
    ...
    return {
        ...
        'check_bias_distribution': check_bias_counter,
        'check_ai_ratio_distribution': check_ai_ratio_counter
    }
...
def generate_report(analysis):
    ...
    if analysis['user_analysis']:
        ...
        # Top 10 users with most common score percentage
